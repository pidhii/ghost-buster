#ifndef BOSON_2BALLS_HPP
#define BOSON_2BALLS_HPP
...
void
generate_states_2(int n_cells, state_set &set)
{
...
class two_balls : public cellular_universe {
  public:
  two_balls(int n_cells)
  : cellular_universe {2}
  { generate_states_2(n_cells, m_S); }
